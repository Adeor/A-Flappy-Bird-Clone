package com.adeor.flappyAnus.GameWorld;

import aurelienribon.tweenengine.Tween;
import aurelienribon.tweenengine.TweenEquations;
import aurelienribon.tweenengine.TweenManager;
import com.adeor.flappyAnus.GameObjects.Bird;
import com.adeor.flappyAnus.GameObjects.Grass;
import com.adeor.flappyAnus.GameObjects.Pipe;
import com.adeor.flappyAnus.GameObjects.ScrollHandler;
import com.adeor.flappyAnus.TweenAccessors.Value;
import com.adeor.flappyAnus.TweenAccessors.ValueAccessor;
import com.adeor.flappyAnus.Helpers.AssetLoader;
import com.adeor.flappyAnus.Helpers.InputHandler;
import com.adeor.flappyAnus.ui.SimpleButton;
...
public class GameRenderer {
	...
	private void drawPipes() {
		batcher.draw(bar, pipe1.getX(), pipe1.getY(), pipe1.getWidth(),
				pipe1.getHeight()-14);
		batcher.draw(bar, pipe1.getX(), pipe1.getY()+14 + pipe1.getHeight() + 45,
				pipe1.getWidth(), midPointY + 66 - (pipe1.getHeight() + 45)+20);

		batcher.draw(bar, pipe2.getX(), pipe2.getY(), pipe2.getWidth(),
				pipe2.getHeight()-14);
		batcher.draw(bar, pipe2.getX(), pipe2.getY()+14 + pipe2.getHeight() + 45,
				pipe2.getWidth(), midPointY + 66 - (pipe2.getHeight() + 45)+20);

		batcher.draw(bar, pipe3.getX(), pipe3.getY(), pipe3.getWidth(),
				pipe3.getHeight()-14);
		batcher.draw(bar, pipe3.getX(), pipe3.getY()+14 + pipe3.getHeight() + 45,
				pipe3.getWidth(), midPointY + 66 - (pipe3.getHeight() + 45)+20);
	}
	...
	public void render(float delta, float runTime) {
		...
		// Draw Dirt
		shapeRenderer.setColor(51 / 255.0f, 42 / 255.0f, 32 / 255.0f, 1);
